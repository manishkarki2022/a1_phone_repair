...
@section('content_header')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Edit Repair Service</h1>
                </div>
                <div class="col-sm-6">
            ...
            <div class="col-md-12">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Edit Repair Service: {{ $repairService->service_name }}</h3>
                    </div>

                    <form action="{{ route('repair-services.update', $repairService) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                               ...
                                               id="service_name"
                                               name="service_name"
                                               value="{{ old('service_name', $repairService->service_name) }}"
                                        ...
                                        <select class="form-control @error('device_type_id') is-invalid @enderror"
                                            ...
                                            @foreach($deviceTypes as $deviceType)
                                                <option value="{{ $deviceType->id }}"
                                                        {{ old('device_type_id', $repairService->device_type_id) == $deviceType->id ? 'selected' : '' }}>
                                                    {{ $deviceType->name }}
                                                </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror"
                                          ...
                                          name="description"
                                          rows="3"
                                          placeholder="Enter service description">{{ old('description', $repairService->description) }}</textarea>
                                @error('description')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number"
                                                   ...
                                                   id="admin_price"
                                                   name="admin_price"
                                                   value="{{ old('admin_price', $repairService->admin_price) }}"
                                                   placeholder="0.00"
                                                   required>
                                            @error('admin_price')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number"
                                                   ...
                                                   id="admin_cost"
                                                   name="admin_cost"
                                                   value="{{ old('admin_cost', $repairService->admin_cost) }}"
                                                   placeholder="0.00">
                                            @error('admin_cost')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number"
                                               ...
                                               value="{{ old('estimated_time_hours', $repairService->estimated_time_hours) }}"
                                               placeholder="Hours"
                                               required>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number"
                                               ...
                                               id="warranty_days"
                                               name="warranty_days"
                                               value="{{ old('warranty_days', $repairService->warranty_days) }}"
                                               placeholder="Days"
                                               required>
                                        @error('warranty_days')
                                            <span class="invalid-feedback">{{ $message }}</span>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number"
                                               ...
                                               id="display_order"
                                               name="display_order"
                                               value="{{ old('display_order', $repairService->display_order) }}"
                                               placeholder="0"
                                               required>
                                        @error('display_order')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('status') is-invalid @enderror"
                                                ...
                                                name="status"
                                                required>
                                            <option value="active" {{ old('status', $repairService->status) == 'active' ? 'selected' : '' }}>Active</option>
                                            <option value="inactive" {{ old('status', $repairService->status) == 'inactive' ? 'selected' : '' }}>Inactive</option>
                                        </select>
                                        @error('status')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    @if($repairService->image)
                                        <div class="mb-2">
                                            <img src="{{ $repairService->image_url }}" alt="Current Image" class="img-thumbnail" width="80">
                                        </div>
                                    @endif
                                    <input type="file"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input"
                                                   ...
                                                   name="is_popular"
                                                   value="1"
                                                   {{ old('is_popular', $repairService->is_popular) ? 'checked' : '' }}>
                        ...
                        <div class="card-footer">
                            ...
                            <form action="{{ route('repair-services.destroy', $repairService) }}"
                                  method="POST"
